...
def main():
    ...
    red_arm_left = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    red_arm_right = Node(base, glm.translate(glm.vec3(.2,0,0)), glm.translate((.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    green_arm_left = Node(red_arm_left, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.5,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    green_arm_right = Node(red_arm_right, glm.translate(glm.vec3(.5,0,0)), glm.translate((.5,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        base.set_joint_transform(glm.translate((glm.sin(t),0,0)))
        red_arm_left.set_joint_transform(glm.rotate(-t, (0,0,1)))
        red_arm_right.set_joint_transform(glm.rotate(t, (0,0,1)))
        green_arm_left.set_joint_transform(glm.rotate(-t, glm.vec3(0,0,1))*glm.translate(glm.vec3(.25,0,0)))
        green_arm_right.set_joint_transform(glm.rotate(t, glm.vec3(0,0,1))*glm.translate(glm.vec3(-.25,0,0)))
        ...
        draw_node(vao_box, red_arm_left, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, red_arm_right, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, green_arm_left, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, green_arm_right, P*V, MVP_loc_box, color_loc_box)
