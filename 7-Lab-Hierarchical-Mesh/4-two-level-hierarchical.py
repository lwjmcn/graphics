...
def main():
    ...
    window = glfwCreateWindow(800, 800, '4-two-level-hierarchical', None, None)
    if not window:
        glfwTerminate()
        return
    ...
    arm2 = Node(arm, glm.vec3(.25,.1,0.), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        arm2.set_transform( glm.translate(glm.vec3(.25, 0, .01)) * glm.rotate(t, glm.vec3(0,0,1))* glm.translate(glm.vec3(-.25, 0, .01)) )
