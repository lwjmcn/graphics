...
def framebuffer_size_callback(window, width, height):
    ...
    # g_P = glm.frustum(-ortho_width*.5,ortho_width*.5, -ortho_height*.5,ortho_height*.5, -10,10)
...
def main():
    ...
    window = glfwCreateWindow(800, 800, '6-viewport-fit-preserve-objratio-perspective', None, None)
    if not window:
        glfwTerminate()
        return
