...
def main():
    ...
    window = glfwCreateWindow(800, 800, '6-drawing-multiple-objects', None, None)
    if not window:
        glfwTerminate()
        return
    ...
    # prepare vaos
    vao_triangle1 = prepare_vao_triangle1()
    vao_triangle2 = prepare_vao_triangle2()
