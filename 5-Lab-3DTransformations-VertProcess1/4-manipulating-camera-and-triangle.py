...
def key_callback(window, key, scancode, action, mods):
    global g_cam_ang, g_cam_height, g_origin_x, g_origin_y, g_origin_z
...
def main():
    ...
    window = glfwCreateWindow(800, 800, '4-manipulating-camera-and-triangle', None, None)
    if not window:
        glfwTerminate()
        return
    ...
    while not glfwWindowShouldClose(window):
        ...
        # tranlation
        T = glm.translate(glm.vec3(g_origin_x, g_origin_y, g_origin_z))
